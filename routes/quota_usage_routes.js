...
module.exports = (app) => {
    ...
    app.put('/api/quota-usage/disable-bus',(req,res) => quotaHandler.handleDisableBus(req,res));
    app.put('/api/quota-usage/disable-lv',(req,res) => quotaHandler.handleDisableLV(req,res));
    app.put('/api/quota-usage/disable-hlv',(req,res) => quotaHandler.handleDisableHLV(req,res));
}
